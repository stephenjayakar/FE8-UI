...
```sh
python3 prototype/tools/inspect_mgba_state.py path/to/state.ss1
```

Use `--json` for machine-readable output:

```sh
python3 prototype/tools/inspect_mgba_state.py state.ss1 --json
```
...
```sh
python3 prototype/tools/inspect_mgba_state.py state.ss1 \
