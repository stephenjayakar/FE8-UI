...
The Pokémblem work is already present on `main` as the single squash commit
`155b55ef` (`support Pokemblem extended rendering`), immediately following
`a96061a4`. The current `main` and `fork/main` point to the same commit. This is
the source checkpoint to preserve before beginning the reorganization.
